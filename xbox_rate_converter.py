...
REGION_INFO = {
    ...
    'sl-SI': {'currency': 'EUR', 'name_en': 'Slovenia',       'name_cn': '斯洛文尼亚'},
    ...
    'bs-Latn-BA': {'currency': 'USD', 'name_en': 'Bosnia and Herzegovina', 'name_cn': '波斯尼亚和黑塞哥维那'},
    'sr-Latn-ME': {'currency': 'EUR', 'name_en': 'Montenegro', 'name_cn': '黑山'},
    'sr-Latn-RS': {'currency': 'RSD', 'name_en': 'Serbia',     'name_cn': '塞尔维亚'},
    # Asia Pacific
